...
import Concessionario.DAO.implementazioniDao.PersonaDao;
...
public class Main {
	...
	*/	
		...
		GestioneConcessionario gestioneConcessionario= new GestioneConcessionario();
		gestioneConcessionario.menu();
	}
